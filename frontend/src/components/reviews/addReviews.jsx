...
const AddReview = () => {
    ...
    const [data, setData] = useState({ positive: 0, negative: 0, reviews:0 });
    ...
    const fetchData = async () => {
      try {
        ...
        console.log("bandara",response.data)
      } catch (error) {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        setData(response.data);
        console.log("sithum",response.data)
        setInputText("");
      } catch (error) {
    ...
    return (
        <div>
          ...
          <div>
            <h2>Reviews</h2>
            <p>Sentiment: {data.review.text}</p>
