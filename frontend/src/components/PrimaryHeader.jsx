  ...
  return (
    <header className="py-4 shadow-sm bg-blue-300">
      <div className="container flex items-center justify-between ">
        <a
          href="/"
          className="text-3xl font-medium font-sans  text-bold uppercase "
        >
          <h1>Cartify</h1>
        </a>
        ...
        <div className="w-full max-w-xl relative flex">
          ...
          <input
            ...
            placeholder="search"
          />
          <button className="bg-white border border-indigo-950 text-blue-950  px-8 rounded-r-md hover:bg-blue-950 hover:text-white transition hidden md:flex items-center justify-center cursor-grab">
            Search
          </button>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <Link
            to={"/cart"}
            className="text-center text-blue-950 hover:text-blue-800 transition relative shadow-xl"
          >
            <div className="text-2xl">
              <i className="fa-solid fa-bag-shopping" />
            </div>
            <div className="text-xs leading-3">Cart</div>
            <div className="absolute -right-3 -top-1 w-5 h-5 rounded-full flex items-center justify-center bg-red-400 text-blue-950 text-xs">
              {cartItemNumber}
            </div>
          </Link>
